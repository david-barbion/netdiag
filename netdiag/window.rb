...
class NetdiagWindow < Gtk::Window
    ...
    def init_ui
        ...
        begin
            local_pb = Gdk::Pixbuf.new(:file => "static/local.png")
            gateway_pb = Gdk::Pixbuf.new(:file => "static/gateway.png")
            internet_pb = Gdk::Pixbuf.new(:file => "static/internet.png")
            conn_pb = Gdk::Pixbuf.new(:file => "static/connection.png")
            conn_pb_alt = Gdk::Pixbuf.new(:file => "static/connection.png")
            conn_pb_alt = conn_pb_alt.saturate_and_pixelate(5.5, true)
            no_conn_pb = Gdk::Pixbuf.new(:file => "static/no_connection.png")
